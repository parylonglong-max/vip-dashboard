...
for token in ['viewMode','品牌视角','renderBrandAdjustmentPanel','renderBrandCalendar','brandSearchInput','输入品牌名称或品牌SN','本月价高数','调价日历','brand-no-metric','该品牌本月无调价指标明细','function dataUrl','data非神银指标表','compositionstart','compositionend','updateBrandSuggestions']:
